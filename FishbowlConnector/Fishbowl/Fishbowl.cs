...
namespace FishbowlConnector
{
    ...
    public class Fishbowl : IDisposable
    {
        ...
        private void Login()
        {
            dynamic cmd = new { LoginRq = new { IAID = 3399 /* Application ID, can be any number */, IAName = "FishBowl API Tester", IADescription = "This is a test", UserName = _user, UserPassword = _pass } };
